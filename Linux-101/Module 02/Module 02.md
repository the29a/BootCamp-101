...
Однако мы можем взглянуть на [http://bashrcgenerator.com/](bashrcgenerator) и [https://github.com/b-ryan/powerline-shell](powerline), что дает нам возможность адаптировать нашу строку нашим потребностям.
